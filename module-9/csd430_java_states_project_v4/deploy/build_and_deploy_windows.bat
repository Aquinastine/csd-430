...
set "MYSQL_JAR=C:\Users\Luttr\csd\csd-430\module-9\csd430_java_states_project_v4\web\WEB-INF\lib\mysql-connector-j-9.6.0"
...
copy /Y "%PROJECT_ROOT%\web\jasonStatesLookup.jsp" "%TOMCAT_WEBAPP%\jasonStatesLookupv4.jsp" >nul
